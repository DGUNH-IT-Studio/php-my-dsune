 ...
 */
final class Version20240124131428 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE lesson_type (id INT NOT NULL, lesson_type_name VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
    }
