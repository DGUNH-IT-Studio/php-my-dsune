...
{
    #[Route('/', name: 'app_education_program_index', methods: ['GET'])]
    ...
    #[Route('/{id}', name: 'app_education_program_show', methods: ['GET'])]
    ...
    #[Route('/{id}/edit', name: 'app_education_program_edit', methods: ['GET', 'POST'])]
    ...
    #[Route('/{id}', name: 'app_education_program_delete', methods: ['POST'])]
